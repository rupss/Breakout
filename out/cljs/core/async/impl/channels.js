...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13077 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t13077');

/**
* @constructor
*/
cljs.core.async.impl.channels.t13077 = (function (val,box,meta13078){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13077.cljs$lang$type = true;
cljs.core.async.impl.channels.t13077.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13077";
cljs.core.async.impl.channels.t13077.cljs$lang$ctorPrWriter = (function (this__3497__auto__,writer__3498__auto__,opt__3499__auto__){return cljs.core._write.call(null,writer__3498__auto__,"cljs.core.async.impl.channels/t13077");
});
cljs.core.async.impl.channels.t13077.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13077.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13079){var self__ = this;
var _13079__$1 = this;return self__.meta13078;
});
cljs.core.async.impl.channels.t13077.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13079,meta13078__$1){var self__ = this;
var _13079__$1 = this;return (new cljs.core.async.impl.channels.t13077(self__.val,self__.box,meta13078__$1));
});
cljs.core.async.impl.channels.__GT_t13077 = (function __GT_t13077(val__$1,box__$1,meta13078){return (new cljs.core.async.impl.channels.t13077(val__$1,box__$1,meta13078));
});
}
return (new cljs.core.async.impl.channels.t13077(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3500__auto__,writer__3501__auto__,opts__3502__auto__){return cljs.core._write.call(null,writer__3501__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3497__auto__,writer__3498__auto__,opt__3499__auto__){return cljs.core._write.call(null,writer__3498__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13080 = self__.takes.pop();if((taker_13080 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13080))
{var take_cb_13081 = cljs.core.async.impl.protocols.commit.call(null,taker_13080);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13081,taker_13080){
return (function (){return take_cb_13081.call(null,null);
});})(take_cb_13081,taker_13080))
);
} else
{}
{
