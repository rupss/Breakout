...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3497__auto__,writer__3498__auto__,opt__3499__auto__){return cljs.core._write.call(null,writer__3498__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13048 = 0;while(true){
if((i_13048 < arr.length))
{(arr[i_13048] = null);
{
var G__13049 = (i_13048 + 1);
i_13048 = G__13049;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3497__auto__,writer__3498__auto__,opt__3499__auto__){return cljs.core._write.call(null,writer__3498__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13055 = (self__.level + 1);while(true){
if((i_13055 <= (new_level + 1)))
{(update[i_13055] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13057 = 0;while(true){
if((i_13057 <= self__.level))
{var links_13058 = (update[i_13057]).forward;if(((links_13058[i_13057]) === x__$1))
{(links_13058[i_13057] = (x__$1.forward[i_13057]));
{
var G__13059 = (i_13057 + 1);
i_13057 = G__13059;
continue;
}
} else
{{
var G__13060 = (i_13057 + 1);
i_13057 = G__13060;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__2961__auto__ = (cljs.core.truth_((function (){var and__2952__auto__ = me;if(cljs.core.truth_(and__2952__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__2952__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__2961__auto__))
