...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13071 = 0;while(true){
var m_13072 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13072 == null))
{} else
{m_13072.call(null);
if((count_13071 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13073 = (count_13071 + 1);
count_13071 = G__13073;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__2952__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__2952__auto__)
