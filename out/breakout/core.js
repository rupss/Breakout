...
breakout.core.move_block_left = (function move_block_left(p__4776,p__4777){var vec__4780 = p__4776;var block_x = cljs.core.nth.call(null,vec__4780,0,null);var block_y = cljs.core.nth.call(null,vec__4780,1,null);var vec__4781 = p__4777;var canvas = cljs.core.nth.call(null,vec__4781,0,null);var context = cljs.core.nth.call(null,vec__4781,1,null);var c_width = cljs.core.nth.call(null,vec__4781,2,null);var c_height = cljs.core.nth.call(null,vec__4781,3,null);var new_block_x = (block_x - 4);if((new_block_x >= 0))
...
breakout.core.move_block_right = (function move_block_right(p__4782,p__4783){var vec__4786 = p__4782;var block_x = cljs.core.nth.call(null,vec__4786,0,null);var block_y = cljs.core.nth.call(null,vec__4786,1,null);var vec__4787 = p__4783;var canvas = cljs.core.nth.call(null,vec__4787,0,null);var context = cljs.core.nth.call(null,vec__4787,1,null);var c_width = cljs.core.nth.call(null,vec__4787,2,null);var c_height = cljs.core.nth.call(null,vec__4787,3,null);var new_block_x = (block_x + 4);var bound = (c_width - breakout.core.block_width);if((new_block_x <= bound))
{return cljs.core.PersistentVector.fromArray([new_block_x,block_y], true);
} else
...
breakout.core.check_ball_block_collision = (function check_ball_block_collision(state){var ball = cljs.core.deref.call(null,state).call(null,new cljs.core.Keyword(null,"ball","ball",1016920433));var block = cljs.core.deref.call(null,state).call(null,new cljs.core.Keyword(null,"block","block",1107736575));var old_dx = cljs.core.deref.call(null,state).call(null,new cljs.core.Keyword(null,"dx","dx",1013907462));var old_dy = cljs.core.deref.call(null,state).call(null,new cljs.core.Keyword(null,"dy","dy",1013907463));if(cljs.core.truth_(breakout.core.ball_rectangle_collision.call(null,block,breakout.core.block_width,breakout.core.block_height,ball)))
{return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"dy","dy",1013907463),(-1 * old_dy));
} else
{return null;
}
});
breakout.core.get_collided_bricks = (function get_collided_bricks(ball,bricks){return cljs.core.filter.call(null,(function (p1__4805_SHARP_){return breakout.core.ball_rectangle_collision.call(null,p1__4805_SHARP_,breakout.core.brick_width,breakout.core.brick_height,ball);
}),bricks);
});
breakout.core.check_ball_brick_collision = (function check_ball_brick_collision(state){var ball = cljs.core.deref.call(null,state).call(null,new cljs.core.Keyword(null,"ball","ball",1016920433));var all_bricks = cljs.core.deref.call(null,state).call(null,new cljs.core.Keyword(null,"bricks","bricks",3928069060));var collided_bricks = breakout.core.get_collided_bricks.call(null,ball,all_bricks);return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"bricks","bricks",3928069060),clojure.set.difference.call(null,all_bricks,cljs.core.set.call(null,collided_bricks)));
});
breakout.core.check_collisions = (function check_collisions(state){breakout.core.check_ball_block_collision.call(null,state);
return breakout.core.check_ball_brick_collision.call(null,state);
});
breakout.core.game_loop = (function game_loop(state,p__4806){var vec__4808 = p__4806;var canvas = cljs.core.nth.call(null,vec__4808,0,null);var context = cljs.core.nth.call(null,vec__4808,1,null);var c_width = cljs.core.nth.call(null,vec__4808,2,null);var c_height = cljs.core.nth.call(null,vec__4808,3,null);var c = vec__4808;setTimeout((function (){return game_loop.call(null,state,c);
}),10);
breakout.core.move_ball.call(null,state);
breakout.core.check_collisions.call(null,state);
context.clearRect(0,0,c_width,c_height);
return breakout.core.draw_everything.call(null,c,cljs.core.deref.call(null,state));
});
breakout.core.init = (function init(){var vec__4811 = breakout.core.get_context.call(null);var canvas = cljs.core.nth.call(null,vec__4811,0,null);var context = cljs.core.nth.call(null,vec__4811,1,null);var c_width = cljs.core.nth.call(null,vec__4811,2,null);var c_height = cljs.core.nth.call(null,vec__4811,3,null);var c = vec__4811;var state = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);cljs.core.swap_BANG_.call(null,state,breakout.core.init_round,c);
window.addEventListener("keydown",(function (p1__4809_SHARP_){return breakout.core.move_block.call(null,state,c,p1__4809_SHARP_);
}),false);
